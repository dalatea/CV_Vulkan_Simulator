...
namespace enginev {
    Pipeline::Pipeline(
        ...
        : device{ device } {
        std::string vertPath = getShaderPath(vertFilepath);
        std::string fragPath = getShaderPath(fragFilepath);
    ...
    std::string Pipeline::getShaderPath(const std::string& filename) {
    ...
    void Pipeline::enablleAlphaBlending(PipelineConfigInfo& configInfo) {

...
Texture::Texture(Device& device, const std::string& imagePath, bool isSRGB)
    : device{ device } {
    VkFormat fmt = isSRGB ? VK_FORMAT_R8G8B8A8_SRGB : VK_FORMAT_R8G8B8A8_UNORM;
    createTextureImage(imagePath, fmt);
    createTextureImageView(fmt);
    createTextureSampler();
}

Texture::Texture(Device& device, uint8_t* pixels, int width, int height, bool isSRGB)
    : device{device} {
    VkFormat fmt = isSRGB ? VK_FORMAT_R8G8B8A8_SRGB : VK_FORMAT_R8G8B8A8_UNORM;
...
void Texture::createTextureImage(const std::string& imagePath, VkFormat format) {

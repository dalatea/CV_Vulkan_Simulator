...
namespace cvsim {
    ...
    SimApp::SimApp(const StressConfig& stressCfg)
        ...
        globalPool =
            ...
            .addPoolSize(VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_KHR, SwapChain::MAX_FRAMES_IN_FLIGHT * 2) 
            .build();
   ...
   std::string SimApp::getAssetPath(const std::string& filename) {
    ...
    void SimApp::run() {
        ...
        std::vector<LensSurfaceGPU> lensSurfacesCpu = {
            ...
            {  0.050f,   0.000f, 1.8f,  0.020f, 0 }, 
            { -0.050f,   0.010f, 1.0f,  0.020f, 0 },  
            {  0.030f,   0.020f, 1.6f,  0.018f, 0 }, 
            { -0.030f,   0.028f, 1.0f,  0.018f, 0 },  
            {  0.0f,     0.035f, 1.0f,  0.012f, 1 }, 
            {  0.040f,   0.040f, 1.5f,  0.020f, 0 }, 
            { -0.040f,   0.050f, 1.0f,  0.020f, 0 },  
            {  0.035f,   0.058f, 1.5f,  0.018f, 0 },  
            { -0.035f,   0.065f, 1.0f,  0.018f, 0 },  
        };
...
*/
        ...
        lensFlarePass->recreate(renderer.getSwapChainExtent(), 0.7f);
        volumetricPass->recreate(renderer.getSwapChainExtent(), 0.5f);
        ...
        while (!window.shouldClose()) {
            ...
            if (commandBuffer) {
                ...
                volPC.texelSize       = { 1.0f / static_cast<float>(extent.width),

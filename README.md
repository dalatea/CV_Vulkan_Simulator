...
5.	GLFW — кроссплатформенная библиотека для создания окон, обработки ввода и графической подсистемой ОС.
  sudo apt install -y libglfw3-dev
6.	Библиотека линейной алгебры
  sudo apt install -y libglm-dev
7.	Библиотека JSON for Modern C++
